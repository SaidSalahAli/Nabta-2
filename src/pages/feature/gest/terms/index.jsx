...
const sections = [
    ...
    content: (
      <>
        <Typography variant="body1" sx={bodyStyle}>
          أهلًا بك في منصّة أستوديو نبتة لصناعة المحتوى التربوي التعليمي للأطفال، ودعم الأمهات والآباء، من خلال الوصول إلى
  ...
  },
  {
    ...
    content: (
      <Typography variant="body1" sx={bodyStyle}>
        إن استخدامك للخدمة يخضع أيضًا لسياسة الخصوصية التابعة لـ أستوديو نبتة. يرجى مراجعة سياسة الخصوصية لدينا، التي تحكم
  ...
  },
  {
    ...
    content: (
      <>
        <Typography variant="body1" sx={bodyStyle}>
          يتم تنسيق المحتوى في أستوديو نبتة وتوفيره وفقًا لقوانين حقوق المُلكيّة الفكرية وحقوق التأليف والنشر. وهو مُخصَّص
  ...
  },
  {
    ...
    content: (
      <>
        <Typography variant="body1" sx={bodyStyle}>
          عند إنشاء حساب في منصّة أستوديو نبتة، يجب عليك تقديم معلومات دقيقة وكاملة. أنت مسؤول عن الحفاظ على سِريّة حسابك
  ...
  },
  {
    ...
    content: (
      <Typography variant="body1" sx={bodyStyle}>
        تحمي حقوق الطبع والنشر وقوانين المُلكيّة الفكرية الأخرى مُلكيّة خدمة "أستوديو نبتة" والجهات المرخصة لها، بالإضافة
  ...
  },
  {
    ...
    content: (
      <Typography variant="body1" sx={bodyStyle}>
        لا تتحمَّل منصّة أستوديو نبتة أي مسؤولية عن أي أضرار غير مباشرة، أو عرضية، أو خاصة، أو عقوبية ناتجة عن إستخدامك
        للخدمة.
      </Typography>
    )
  },
  {
    ...
    content: (
      <Typography variant="body1" sx={bodyStyle}>
        يتم تقديم الخدمة "كما هي" و"حسب التوفُّر". لا تُقدِّم أستوديو نبتة أي ضمانات بخصوص الخدمة، سواء كانت صريحة أم
        ضمنية.
      </Typography>
    )
  },
  ...
  },
  {
    ...
    content: (
      <Typography variant="body1" sx={bodyStyle}>
        ...
        المستخدمين الأساسيين. إن استمرارك في إستخدام منصّة أستوديو نبتة يعني موافقتك على هذه التغييرات.
      </Typography>
    )
  },
  {
    ...
    <Fade in={checked} timeout={800}>
      <Box sx={{ py: 8, width: '100%', minHeight: '100vh', backgroundColor: '#fcfcfc' }}>
        <SEO 
          ...
          description="اتفاقية شروط الاستخدام والأحكام الخاصة بمنصة أستوديو نبتة للأطفال لدعم الأمهات والآباء وصناعة المحتوى التربوي."
          keywords="شروط الاستخدام نبتة, الأحكام والشروط, اتفاقية نبتة"
          url="/terms"
        />
