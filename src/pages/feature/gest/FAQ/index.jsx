...
const faqs = [
  {
    ...
    answer:
      'منصة نبتة هي منصة صناعة محتوى تربوي تعليمي للأطفال، ودعم الأمهات والآباء من خلال: (نصائح تربوية - تطبيقات تعليمية - فيديوهات توعوية - أوراق مذاكرة وتلوين - ورش عمل - أنشطة وألعاب تفاعلية).'
  },
  {
    id: 2,
    question: 'ما المحتوى الذي تقدمه منصة نبتة؟',
    answer: 'يقدم تطبيق لغتي العربية محتوى تعليمي تربوي تفاعلي للأطفال، وبه شئ من المرح يتناسب مع أعمارهم، وهو عبارة عن تعليم الحروف العربية للأطفال، بأشكال متعددة بالطريقة الصوتية، وهذه هي الطريقة المناسبة والأصح في تعليم اللغة العربية، وأيضًا يقدم التطبيق إمكانية طباعة أوراق المذاكرة مع كل مرحلة تعليمية، بحيث يتمكن الطفل من إتقان المرحلة التعليمية الحالية بشكل عملي وجيد.'
  },
  {
    id: 3,
    ...
    <Fade in={checked} timeout={800}>
      <Box sx={{ py: 6, width: '100%', minHeight: '100vh', backgroundColor: '#fcfcfc' }}>
        <SEO
          ...
          description="إجابات على الأسئلة الشائعة حول منصة نبتة وتطبيق لغتي العربية والاشتراكات وطرق التحميل والاستخدام الآمن للأطفال."
          keywords="الأسئلة الشائعة منصة نبتة, استفسارات منصة نبتة, كيفية الاشتراك في منصة نبتة"
          url="/faq"
        />
